...
echo "  rm -f \$DOCROOT/index.html \$DOCROOT/*.svg \$DOCROOT/robots.txt \$DOCROOT/manifest.webmanifest"
echo "  cp -r dist/assets dist/index.html dist/*.svg dist/robots.txt dist/manifest.webmanifest \$DOCROOT/"
echo ""
echo "  # Verifikim:"
