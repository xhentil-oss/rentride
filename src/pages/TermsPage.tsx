  ...
  const sections = [
    {
      ...
      content: `Duke aksesuar ose përdorur platformat dixhitale dhe shërbimet e Rent Ride (\"Kompania\"), ju pranoni të lidheni me këto Kushte Shërbimi. Nëse nuk jeni dakord me ndonjë nga kushtet e mëposhtme, ju lutemi mos e përdorni shërbimin tonë.
...
Këto kushte zbatohen për të gjitha shërbimet e qirasë automobilistike që ofrojmë, duke përfshirë rezervimet online, rezervimet telefonike dhe walk-in.`,
    },
    {
      ...
      content: `Për të marrë me qira një mjet nga Rent Ride, drejtuesit duhet:
...
Rent Ride ruan të drejtën të refuzojë çdo rezervim pa dhënë arsye, me rimbursim të plotë të çdo pagese të bërë.`,
    },
    {
...
Nëse ndonjë dispozitë e këtyre kushteve çmohet e paligjshme ose e pazbatueshme, dispozitat e tjera mbeten në fuqi të plënë.`,
    },
    {
      ...
      content: `Rent Ride ruan të drejtën të modifikojë këto Kushte Shërbimi në çdo kohë. Ndryshimet hyjnë në fuqi menjëherë pas publikimit në faqen tonë të internetit. Vazhdimi i përdorimit të shërbimeve tona pas ndryshimeve nënkupton pranimin e kushteve të reja.`,
    },
  ];
